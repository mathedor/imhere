...
export function ComingSoon({ icon: Icon = Sparkles, title, description }: Props) {
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center gap-5 px-5 py-16 text-center">
      <motion.div
